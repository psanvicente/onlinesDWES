...
<head>
    ...
    <title>Reservas Online Vehículos</title>
</head>
<?php session_start();?>
...
<body>
    ...
    <div id="contenedor">
        <h1>Bienvenidos a nuestra web de reserva online</h1>
        <h2>Nuestras marcas.</h2>
        <div class="marcas" id="citroen"></div>
        <div class="marcas" id="audi"></div>
        <div class="marcas" id="bmw"></div>
        <div class="marcas" id="kia"></div>
        <div class="marcas" id="hyundai"></div>
        <br />
        <?php if (isset($_SESSION['username']) === false) { ?>

        <?php } else { ?>

        <button onclick='location.href="cliente.php"'>Entrar a la web</button>
